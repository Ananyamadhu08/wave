        ...
        >
          ...
          <div className="fixed inset-0 overflow-y-auto min-h-screen ">
            <div className="flex items-center justify-center p-4 text-center relative top-24">
              ...
              >
                <Dialog.Panel className="w-full max-h-[80vh] overflow-y-scroll max-w-md transform rounded-2xl bg-cyan-50 p-6 text-left align-middle shadow-xl transition-all dark:text-white dark:bg-slate-800 overflow-scroll">
                  <Dialog.Title
                    as="h3"
                    className="text-lg flex justify-between items-center font-medium leading-6 text-slate-900 dark:text-cyan-100"
                  >
                    Edit Profile
                    <button
                      type="span"
                  ...
                  <form onSubmit={handleSubmit}>
                    <div className="w-40 h-40 rounded-[50%] overflow-hidden relative my-4 mx-auto cursor-pointer border border-solid border-white group">
                      ...
                      />
                      <span className="absolute left-0 w-full text-center text-cyan-500 bg-slate-100 bottom-[-100%] h-[50%] group-hover:bottom-[-15%]">
                        <p className="text-cyan-500">Change Image</p>
                        <input
                          type="file"
                          name="file"
                          id="file_up"
                    ...
                    <button
                      type="submit"
                      className="mt-2 inline-flex justify-start rounded-md border border-transparent bg-slate-900 dark:bg-blue-100 px-4 py-2 text-sm font-medium text-cyan-100 dark:text-blue-900 hover:bg-blue-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2"
                    >
                      Update Info
                    </button>
                  </form>
